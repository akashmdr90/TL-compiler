...
public class Writer {
	public static String WriteTokenFile(String filepath, String filename,
			List<TokenInfo> tokenlist) throws IOException {
		String filewithpath = filepath + File.separator + filename.substring(0,filename.indexOf("."))  + ".tok";
	...
	public static String WriteTokenError(String filepath, String filename,
			List<String> tokenlist) throws IOException {
		String filewithpath = filepath + File.separator + filename.substring(0,filename.indexOf(".")) + ".tok";
	...
	public static String writToFile(String pContent, String filepath,
