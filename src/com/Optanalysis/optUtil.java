package com.Optanalysis;
import java.util.ArrayList;
import java.util.HashMap;
import java.util.Hashtable;
import java.util.List;
import java.util.Map;
import com.MIPScode.GlobalName;
import com.MIPScode.Instruction;
import com.MIPScode.MIPSGen;
...
public class optUtil {
	...
	public optUtil(Map<String, Block> pBlockMap) {
		mBlockMap = pBlockMap;
	}
