...
public class Expr extends TempNode {

	private SimpleExpn mParseSimpleExpression;
	private ExprExtn mExpression1;
	private int mCount;
	...
	public Expr(SimpleExpn pParseSimpleExpression, ExprExtn pExpression1) {
		mParseSimpleExpression = pParseSimpleExpression;
		mExpression1 = pExpression1;

	}

	public ExprExtn getExpression1() {
		return mExpression1;
	}
